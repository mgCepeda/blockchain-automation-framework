...
*/}}
{{- define "fabric-update-block.name" -}}
...
*/}}
{{- define "fabric-update-block.fullname" -}}
{{- $name := default .Chart.Name -}}
{{- if contains $name .Release.Name -}}
{{- printf "%s-update" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
...
*/}}
{{- define "fabric-update-block.chart" -}}
...
*/}}
{{- define "fabric-update-block.orderercrt" -}}
...
*/}}
{{- printf "%s-orderer-tls-cacert" .Values.peerName -}}
{{- end -}}
{{- end -}}
